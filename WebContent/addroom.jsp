...
<form method="post" action="addroomconn.jsp">
            <center>
<table border="2" width="30%" cellpadding="7"  >
                <thead>
                    <tr>
                        <th colspan="2">Add room here</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>Add room number</td>
                        <td><input type="text" name="roomnum" value=""/></td>
                    </tr>
                    
                        <td><input type="submit" value="Submit" onclick="adds()"required="required"/></td>
                        <script>
            function adds()
            {
